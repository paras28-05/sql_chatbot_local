...
langsmith_api_key = "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"
...
st.text_area('Chat History', value='\n'.join([f"{msg}: {resp}" for msg, resp in st.session_state.history]), height=300)

user_input = st.text_input('Enter your SQL query:')
if st.button('Submit'):
    if user_input:
        new_history = respond(user_input, st.session_state['history'], st.session_state['session_id'])
